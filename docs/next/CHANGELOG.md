...
### Added
- Added Mistral Vibe screen detection for live working and blocked states, optional cross-platform session reporting, and native restore with `vibe --resume <id>`.
